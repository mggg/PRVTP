...
job_name="1_bloc_opt_$(date '+%d-%m-%Y@%H:%M:%SET')"
sleep_length=45
...
# on line 167 or so
running_script_name="single_run_1_bloc_opt.sh"
...
# elections=("glasgow 2012 16" "north-ayrshire 2022 1")

models=("IC" "IAC") #("IC" "IAC" "CS-W" "CS-C" "SB" "s-PL" "n-PL" "s-BT" "n-BT")
bloc_order="AB"
